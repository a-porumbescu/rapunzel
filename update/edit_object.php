...
if(isset($_POST['submit'])){
    ...
    $sql = "UPDATE `objects` SET `id_pers`='$id_pers',`object`='$name' WHERE id=$id";
        ...
        <form action="" method="post" style="width:50vw; min-width:300px;">
            <div class="row mb-3">
                <div class="col">
                    ...
                    <input type="text" class="form-control" name="name" value="<?php echo $row['object'] ?>"> 
                </div>
                <div class="col">
